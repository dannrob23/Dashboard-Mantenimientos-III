...
headers = [
    ("ID_Orden", 8), ("Nombre_Oficina", 18), ("Municipio", 13), ("Departamento", 13),
    ("Region", 13), ("Tecnico_Operativo", 18), ("Tecnico_Calidad", 13),
    ("Fecha_Programada_Inicio", 13), ("Fecha_Programada_Fin", 13),
    ("Fecha_Inicio_Real", 12), ("Fecha_Cierre_Operativo", 13), ("Estado_Mantenimiento", 15),
    ("Fecha_Nueva_Programada", 13), ("Cumpli_Ingreso", 10), ("Cumpli_Salida", 10),
    ("Cumpli_Cronograma", 12), ("Dias_Desviacion", 10), ("Causal_Desviacion", 19),
    ("Estatus_Acta", 15), ("Fecha_Cierre_Administrativo", 13), ("Cantidad_Equipos", 10),
    ("Observaciones_Calidad", 42),
]
